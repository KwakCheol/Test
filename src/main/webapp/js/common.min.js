...
function fPhoneNumber(num){
	var ret="";
	if (num.length==10){
		ret = num.substring(0,3) + "-" + num.substring(3,6) + "-" + num.substring(6,10);
	} else if (num.length==11){
		ret = num.substring(0,3) + "-" + num.substring(3,7) + "-" + num.substring(7,11);
	} else {
		ret = num;
	}
	return ret;
...
// 타임스탬프값 날짜형식으로 변경(예)2016-04-30 08:36:26.000)
